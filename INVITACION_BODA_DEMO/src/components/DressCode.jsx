...
const DressCode = () => {
  const prohibitedColors = [
    ...
    { name: 'Crema', color: 'bg-neutral-50' }
  ];

  return (
    <section id="dress-code" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-4 bg-gradient-to-br from-accent-50 via-secondary-50 to-accent-100 relative overflow-hidden">
      {/* Fondo decorativo */}
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-72 h-72 bg-gradient-to-br from-accent-200/30 to-secondary-200/30 rounded-full blur-3xl"></div>
        <div className="absolute top-32 right-20 w-96 h-96 bg-gradient-to-bl from-secondary-200/25 to-accent-200/25 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-gradient-to-tr from-accent-200/35 to-secondary-200/35 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-1/3 w-64 h-64 bg-gradient-to-tl from-secondary-200/30 to-accent-200/30 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10 px-4 sm:px-6 md:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-fraunces font-bold text-primary-800 mb-6 sm:mb-8 tracking-tight">
            <span className="bg-gradient-to-r from-primary-800 via-accent-700 to-primary-800 bg-clip-text text-transparent">
              Código de Vestimenta
            </span>
          </h2>
          
          <div className="flex items-center justify-center mb-8">
            <div className="w-24 h-px bg-gradient-to-r from-transparent via-accent-500 to-transparent"></div>
            <div className="w-24 h-px bg-gradient-to-l from-transparent via-accent-500 to-transparent"></div>
          </div>
          
          <p className="text-xl md:text-2xl text-primary-700 max-w-4xl mx-auto leading-relaxed font-poppins font-medium">
