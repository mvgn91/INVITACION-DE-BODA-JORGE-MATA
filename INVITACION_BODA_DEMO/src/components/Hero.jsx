...
const Hero = memo(() => {
  ...
  return (
    <section id="hero" className="relative h-screen max-h-[100vh] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary-900/80 via-secondary-900/70 to-primary-800/80"></div>
      
      {/* Patrón decorativo de fondo - reducido */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 20% 20%, rgba(14,165,233,0.2) 0%, transparent 50%),
                           radial-gradient(circle at 80% 80%, rgba(6,182,212,0.15) 0%, transparent 50%),
                           radial-gradient(circle at 50% 50%, rgba(226,232,240,0.05) 0%, transparent 70%)`,
        }}></div>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-primary-900/30 via-primary-800/10 to-secondary-900/20"></div>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-neutral-500/30 rounded-full"
            style={{
              left: `${20 + i * 15}%`,
              top: `${30 + (i % 3) * 20}%`,
            }}
      ...
      <div className="relative z-10 flex flex-col justify-between min-h-screen px-3 pt-8 pb-20 sm:px-4 sm:pt-12 sm:pb-24 md:px-6 md:pt-16 md:pb-28 lg:px-8 lg:pt-20 lg:pb-32">
        <div className="w-full max-w-6xl mx-auto flex-1 flex flex-col justify-center">
          ...
          <div className="text-center space-y-6 sm:space-y-6 md:space-y-8 lg:space-y-10">
            ...
            >
              <motion.p
                className="text-neutral-300 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-poppins tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.2em] lg:tracking-[0.3em] uppercase px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-20"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <h1 className="font-fraunces font-bold leading-[0.75] sm:leading-[0.8] md:leading-[0.85] lg:leading-[0.9] tracking-tight" style={{ fontSize: 'min(14svh, 6em)' }}>
                ...
                >
                  ...
                  >
                    <motion.span
                      style={{
                        background: "linear-gradient(45deg, #0ea5e9, #06b6d4, #ffffff, #0ea5e9)",
                  ...
                  >
                    <motion.span 
                      ...
                      style={{ 
                        ...
                        background: "linear-gradient(45deg, #ffffff, #0ea5e9, #06b6d4, #ffffff)",
                        backgroundSize: "400% 400%",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                        backgroundClip: "text",
                  ...
                  >
                    <motion.span
                      style={{
                        background: "linear-gradient(45deg, #06b6d4, #ffffff, #0ea5e9, #06b6d4)",
                        backgroundSize: "400% 400%",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                        backgroundClip: "text",
            ...
            >
              <motion.button
                ...
                className="group relative px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-2 md:py-3 lg:py-4 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-poppins font-semibold rounded-full hover:from-primary-600 hover:to-secondary-600 transition-all duration-300 text-xs sm:text-xs md:text-sm lg:text-base uppercase tracking-wider overflow-hidden active:scale-95 active:from-primary-600 active:to-secondary-600"
              ...
              <motion.button
                ...
                className="group px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-2 md:py-3 lg:py-4 border-2 border-neutral-400 text-neutral-300 font-poppins font-semibold rounded-full hover:bg-neutral-400 hover:text-primary-900 transition-all duration-300 text-xs sm:text-xs md:text-sm lg:text-base uppercase tracking-wider active:scale-95 active:bg-neutral-400/20"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
      ...
      >
        <motion.button
          ...
          className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-18 lg:h-18 xl:w-20 xl:h-20 bg-neutral-400/20 backdrop-blur-sm border border-neutral-400/50 rounded-full flex items-center justify-center text-neutral-300 hover:bg-neutral-400/30 hover:text-white hover:border-neutral-400/70 transition-all duration-200 active:scale-95 active:bg-neutral-400/40"
          whileTap={{ scale: 0.95 }}
          animate={{ y: [0, 4, 0] }}
          transition={{ 
            y: { 
