...
const Reception = () => {
  const eventDate = new Date('2025-08-20');
  
  const generateGoogleCalendarLink = () => {
    const startDate = eventDate.toISOString().replace(/[-:]/g, '').split('.')[0] + 'Z';
    const endDate = new Date(eventDate.getTime() + 4 * 60 * 60 * 1000).toISOString().replace(/[-:]/g, '').split('.')[0] + 'Z';
    
    const details = encodeURIComponent('Boda de María Elena Rodríguez y Carlos Antonio López\n\nDetalles de la recepción se confirmarán próximamente.\n\n¡Esperamos verte ahí!');
    const location = encodeURIComponent('Ubicación por confirmar');
    
    return `https://calendar.google.com/calendar/render?action=TEMPLATE&text=Boda de María Elena y Carlos&dates=${startDate}/${endDate}&details=${details}&location=${location}`;
  };
...
DTSTART:${startDate}
DTEND:${endDate}
SUMMARY:Boda de María Elena y Carlos
DESCRIPTION:Boda de María Elena Rodríguez y Carlos Antonio López\\n\\nDetalles de la recepción se confirmarán próximamente.\\n\\n¡Esperamos verte ahí!
...
END:VCALENDAR`;
  ...
  return (
    <section id="reception" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-4 bg-gradient-to-br from-neutral-50 via-white to-secondary-50 relative overflow-hidden">
      {/* Fondo decorativo */}
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-72 h-72 bg-gradient-to-br from-secondary-100/40 to-primary-100/40 rounded-full blur-3xl"></div>
        <div className="absolute top-32 right-20 w-96 h-96 bg-gradient-to-bl from-primary-100/30 to-secondary-100/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-gradient-to-tr from-secondary-100/35 to-primary-100/35 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-1/3 w-64 h-64 bg-gradient-to-tl from-secondary-100/40 to-primary-100/40 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 md:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-fraunces font-bold text-primary-800 mb-6 sm:mb-8 tracking-tight">
            <span className="bg-gradient-to-r from-primary-800 via-secondary-600 to-primary-800 bg-clip-text text-transparent">
              Recepción
            </span>
          </h2>
        ...
        >
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-8">
              <div className="w-24 h-px bg-gradient-to-r from-transparent via-secondary-300 to-transparent"></div>
              <div className="w-24 h-px bg-gradient-to-l from-transparent via-secondary-300 to-transparent"></div>
            </div>
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-fraunces font-bold text-primary-800 mb-4">
              Hotel Hilton Guadalajara
            </h3>
            <p className="text-lg md:text-xl font-poppins text-primary-600 max-w-3xl mx-auto leading-relaxed">
              Av. López Mateos Sur #2077, Col. del Valle, 44500 Guadalajara, Jal
            </p>
            <div className="mt-4 inline-block px-6 py-3 bg-gradient-to-r from-accent-100 to-secondary-100 rounded-2xl border border-accent-200/50">
              <p className="text-base font-poppins font-semibold text-accent-800">
                *Sujeta a cambios
              </p>
            </div>
          </div>
          
          <div className="relative bg-white/95 backdrop-blur-lg rounded-3xl p-8 border border-secondary-500/30 shadow-2xl hover:shadow-3xl transition-all duration-700">
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-secondary-500/5 to-primary-500/10"></div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-8">
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-gradient-to-r from-rose-500/20 to-burgundy-500/20 rounded-2xl p-6 border border-rose/30">
                    ...
                    <p className="text-lg font-poppins font-semibold text-burgundy-700 mb-2">Hotel Hilton Guadalajara</p>
                    <p className="text-base font-poppins text-burgundy-600">Av. López Mateos Sur #2077, Col. del Valle</p>
                    <p className="text-sm font-poppins text-burgundy-500">44500 Guadalajara, Jal</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-2xl p-6 border border-amber/30">
                    ...
                    <div className="space-y-3">
                      <a
                        href="https://maps.app.goo.gl/hotel-hilton-guadalajara"
                        target="_blank"
                      ...
                      <a
                        href="https://www.waze.com/en/live-map/directions/mx/jal./guadalajara/hotel-hilton"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <div className="lg:col-span-2 hidden sm:block">
                  <div className="relative overflow-hidden rounded-2xl shadow-xl">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.123456789!2d-103.3456789!3d20.6789012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428b1234567890%3A0x1234567890abcdef!2sHotel%20Hilton%20Guadalajara!5e0!3m2!1ses-419!2smx!4v1757285542922!5m2!1ses-419!2smx" 
                      width="100%" 
                      height="300" 
                      style={{border: 0}} 
                      allowFullScreen="" 
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center items-center">
              ...
              <motion.a
                ...
                download="boda-maria-carlos.ics"
