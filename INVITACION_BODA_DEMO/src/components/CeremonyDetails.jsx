    ...
    <section id="ceremony" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-4 bg-gradient-to-br from-burgundy-900 via-wine-800 to-burgundy-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 md:px-8">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-fraunces font-bold text-pearl-100 mb-6 sm:mb-8 tracking-tight">
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-fraunces font-bold text-pearl-100 mb-6 tracking-tight">
              <span className="bg-gradient-to-r from-pearl-100 via-rose-300 to-pearl-100 bg-clip-text text-transparent">
                Ubicación
              </span>
            </h3>
              ...
              <div className="grid lg:grid-cols-3 gap-8 mb-8">
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-gradient-to-r from-rose-500/20 to-burgundy-500/20 rounded-2xl p-6 border border-rose/30">
                    ...
                    <p className="text-xl sm:text-2xl font-poppins font-semibold text-pearl-200 mb-2">Catedral de Guadalajara</p>
                    <p className="text-base font-poppins text-pearl-300">Av. Fray Antonio Alcalde #10</p>
                    <p className="text-base font-poppins text-pearl-300">Centro Histórico, Guadalajara</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-accent-500/20 to-secondary-500/20 rounded-2xl p-6 border border-accent-500/30">
                    <h4 className="text-xl font-fraunces font-bold text-neutral-100 mb-4 flex items-center">
                      <Navigation className="w-6 h-6 text-accent-400 mr-3" />
                      Cómo llegar
                    </h4>
